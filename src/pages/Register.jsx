      ...
      <div className="col col-xl-10">
        <div className="card " style={{borderRadius: '2rem',backgroundColor: '#ebfde3ff'}}>
          <div className="row g-0">
            <div className="col-md-6 col-lg-5 d-none d-md-block p-2  ">
            ...
            <div className="col-md-6 col-lg-7 d-flex align-items-center">
              <div className="card-body p-4 p-lg-5 text-black">
                <form>
                  ...
                  <h5 className="fw-normal mb-3 pb-3 ms-1 text-center" style={{letterSpacing: 1}}>Register your account</h5>
                   <div data-mdb-input-init className="form-outline mb-4">
                    <label className="form-label ms-2" htmlFor="form2Example17">Name</label>
                    <input type="text" id="form2Example17" className="form-control form-control-lg rounded-pill" placeholder='Enter your name' />
                  </div>
                  <div data-mdb-input-init className="form-outline mb-4">
                  ...
                  <div className="pt-1 mb-4 text-center">
                    <button data-mdb-button-init data-mdb-ripple-init className="btn btn-dark btn-lg btn-block" type="button">Register</button>
                  </div>

                  <div className="d-flex flex-column align-items-center justify-content-center">
                  <p className="mb-5 pb-lg-2 text-center" style={{color: '#393f81'}}>Already have an account? <Link to="/login" style={{color: '#393f81'}}>Login here</Link></p>
